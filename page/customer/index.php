    ...
    <nav class="navbar navbar-default navbar-fixed-top" style="background:#d74b35;">
      <div class="container-fluid">
        <div class="navbar-header">
         ...
         <a class="navbar-brand" href="#">Toko Buku Online </a>        </div>
    ...
    <div class="jumbotron">
     ...
     <img src="../../img/buku31.jpg">   
      ...
      <div class="col-md-6" style="margin-left:70px; margin-top: 80px;">
        <h2><b>Selamat datang di toko buku mur<strong>ah.</strong></h2>
...
<b>Buku Kami</b>
  ...
  <div class="footer" style="width:100%;height:270px;color:#fff;background:#d74b35;">
      ...
      <div style="margin:50px;height:120px;">
        <center>
        <ul>
          <li style="color:#f97b61"><h3><b>Tentang toko buku</b></h3></li>
        </ul></center>
          <hr>
        <ul>
      ...
      <div style="margin:50px;height:120px;">
        ...
        <center >&copy; 2017 Karya anak IT UHO</center>
        </div>
  </div>
  </body>
</html>