    ...
    <nav class="navbar navbar-default navbar-fixed-top" style="background:#d74b35;">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a href="#" class="navbar-brand style1">TOKO BUKU ONLINE </a>        </div>
    ...
    <div class="jumbotron">
     ...
     <img src="img/buku31.jpg">   
      ...
      <div class="col-md-6" style="margin-left:70px; margin-top: 80px;">
        <h2><b>Selamat datang di toko buku murah.<h1 style="color:#f97b61;"><strong>TOKO BUKU ONLINE </strong></h1>
        </h2>
...
<b>Buku Kami</b>
    ...
    <div class="footer" style="width:100%;height:270px;color:#fff;background:#d74b35;">
      ...
      <div style="margin:50px;height:120px;">
        <center>
        <ul>
          <li style="color:#f97b61"><h3><b>Tentang TOKO BUKU ONLINE</b></h3></li>
        </ul></center>
          <hr>
        <ul>
          <li><b>TOKO BUKU ONLINE</b> adalah</li>
      ...
      <div style="margin:50px;height:120px;">
        ...
        <ul>
          ...
          <ul>
          <li>Jalan Lumba-lumba</li>
          <li>Kelurahan Lalolara</li>
          <li>Kecamatan Kambu</li>
          <li>Kota Kendari, Sulawesi Tenggara</li>
          <li></li>
        </ul>
